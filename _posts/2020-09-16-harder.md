...
See <[http://wiki.alpinelinux.org/](http://wiki.alpinelinux.org/)>.You can setup the system with the command: setup-alpineYou may change this message by editing /etc/motd.harder:~$
```

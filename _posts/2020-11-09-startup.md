...
```console
local@local:~/Documents/tryhackme/startup</b></font>$ wget https://github.com/DominicBreuker/pspy/releases/download/v1.2.0/pspy64
...
Looking at the content of that file, it also executed a second file. ie **/etc/print.sh**.
...
bash-4.3# 
```
\-p flag should be used as without it, the permissions will be dropped
